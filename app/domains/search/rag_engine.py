...
class RAGEngine:
    ...
    async def generate_diagnosis_report(self, mold_name: str, probability: float, context_text: str) -> str:
        ...
        반드시 다음과 같은 JSON 형식으로만 답변하세요. 키 이름과 타입을 정확히 맞추세요:
        {{
          "diagnosis": "곰팡이 종류와 특징에 대한 간결한 진단 설명 (2~3문장)",
          "FrequentlyVisitedAreas": ["주로 발생하는 장소 1", "장소 2"],
          "solution": ["해결 방법 1", "해결 방법 2", "해결 방법 3"],
          "prevention": ["예방법 1", "예방법 2", "예방법 3"],
          "insight": "AI 전문가의 추가 조언과 주의사항 (2~3문장)"
        }}
        """
